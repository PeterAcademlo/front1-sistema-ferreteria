...
interface ModalAlmacenamientoProps {
  showModal: boolean;
  onClose: () => void;
...
const ModalAlmacenamiento: React.FC<ModalAlmacenamientoProps> = ({
  showModal,
  onClose,
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (user.role !== "SECRETARIO" && user.role !== "ADMIN") {
      throw new Error(
        "No tienes permisos para acceder al almacenamiento. Se requiere rol SECRETARIO o ADMIN"
      );
    }
...
export default ModalAlmacenamiento;